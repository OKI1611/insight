...
- **✅ W6 바울서신(13권, +109)**: 롬12·고전11·고후10·갈9·엡10·빌8·골8·살전8·살후7·딤전8·딤후7·딛6·몬5.
- **✅ W7 일반서신·계(9권, +69)**: 히12·약9·벧전9·벧후6·요일9·요이4·요삼3·유6·계11.
- 권별 Q&A 총계: **2,043**. 66권 유지, 금지어·세례 0, 중복 0·거부 0(178개 전량 유효). qa-book.json·our_book_titles.json 재생성 완료.
- **🎉 66권 전권 격차보강 1차 완료.** (W1~W7 누계 신규 약 +540)
- **✅ 2차 심화 1차(큰 책 4권, +60)**: 창세기+15(→67)·시편+15(→67)·이사야+15(→60)·마태복음+15(→70). 권별 Q&A 총계 **2,103**. 저장 staging은 `book_{Eng}_2.json`. 금지어·세례 0, 중복0·거부0.
- 다음(선택): 큰 책 2차 추가 대상 = 복음서(막·눅·요)·로마서·요한계시록·에스겔·예레미야 등. 기존 our_book_titles.json 대조 필수.
