...
## 진행 현황
- **✅ 웨이브 1 완료·병합(6권, +33)**: 창세기+15·출애굽기+5·레위기+6·민수기+4·신명기+2·여호수아+1.
- 권별 Q&A 총계: **1,495 → 1,528** (FAQ 전체 1,768). 66권 유지, 금지어·세례 0.
- 다음 재개: **W2 역사서(사사기~에스더)** 부터. our_book_titles.json 재생성 완료(대조 준비됨).
