...
--   tier: 1=Associate(3급) · 2=Professional(2급) · 3=Expert(1급). 상위 등급은 하위 과정을 포함합니다.
--   부여 예: insert into cert_access(user_id, tier, package) values ('<유저UUID>', 1, 'Associate');
-- ============================================================
create table if not exists public.cert_access (
  user_id    uuid primary key references auth.users(id) on delete cascade,
  tier       int not null default 0,    -- 0=없음, 1=Associate, 2=Professional, 3=Expert
