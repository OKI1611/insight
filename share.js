...
(function(){
  ...
  function toast(m){
    ...
    t.style.cssText='position:fixed;left:50%;bottom:96px;transform:translateX(-50%);background:#2b3440;color:#f8f9f6;padding:10px 18px;border-radius:9999px;font-size:14px;z-index:2147483647;font-family:Pretendard,system-ui,sans-serif;box-shadow:0 8px 28px rgba(0,0,0,.3)';
  ...
  window.biblyShare = function(title, url){
    ...
    var h='<div style="text-align:center;font-weight:700;color:#2b3440;padding:6px 0 4px;font-size:15px">공유하기</div>';
    ...
    rows.forEach(function(r,i){
      ...
      h+='<button data-i="'+i+'" style="width:100%;text-align:left;display:flex;align-items:center;gap:13px;padding:12px 18px;border:0;background:none;font-size:15px;color:#2b3440;cursor:pointer;border-radius:10px"><span style="width:22px;text-align:center">'+r[0]+'</span>'+r[1]+'</button>';
    });
    sheet.innerHTML=h;
