...
def make_cover():
    ...
    center(1900, "바이블 인사이트", fr, 48, GRAY)
...
def main():
    ...
    _isbn = APX.PUB["isbn"].get("parallel_epub", "")
 ...
 '<dc:rights>' + APX.PUB["rights"] + '</dc:rights>\n'
        '<dc:description>킹제임스 성경(KJV, 1611 흠정 · 1769 표준 본문) 영어 본문과 새로 옮긴 한국어 본문을 절 단위로 대조한 한영대역 성경.</dc:description>\n'
