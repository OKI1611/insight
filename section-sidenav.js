...
(function(){
  ...
  function render(sec){
    ...
    st.textContent =
      ...
      + '#sectionSideNav .hd:after{content:"";position:absolute;left:10px;bottom:0;width:20px;height:2px;background:#0f766e;border-radius:2px}'
      ...
      + '#sectionSideNav a.on{background:#ecfdf5;box-shadow:inset 3px 0 0 #0f766e}'
      + '#sectionSideNav a.on .lbl{color:#134e4a;font-weight:800}'
